...
const TimtaReport = () => {
    return (
        <>
            <div className="w-full h-auto sm:h-[60vh] xs:h-[70vh] min-h-[60vh]
               ...
               <div className="w-full">
                    <div className='w-2/6 h-[3em] min-w-60 
                        ...
                        <h1 className='text-xs md:text-base lg:text-lg'>TIMTA REPORT</h1>
                    </div>
               </div>
